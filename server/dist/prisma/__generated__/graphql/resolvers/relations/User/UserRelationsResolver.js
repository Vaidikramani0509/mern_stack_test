...
let UserRelationsResolver = class UserRelationsResolver {
    ...
    async profile(user, ctx, info, args) {
        ...
        }).profile(Object.assign(Object.assign({}, args), (_count && (0, helpers_1.transformCountFieldIntoSelectRelationsCount)(_count))));
    }
};
...
__decorate([
    ...
    __param(3, TypeGraphQL.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [User_1.User, Object, Object, UserProfileArgs_1.UserProfileArgs]),
    __metadata("design:returntype", Promise)
